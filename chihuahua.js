...
const CHAIN_CONFIGS = [
  {
    ...
    rpcUrls: [
      ...
      'https://chihuahua-rpc.polkachu.com:443',
      'https://rpc.chihuahua.wtf:443',
    ],
    prefix: 'chihuahua',
    coinType: 118,
    gasPrice: '120.0', // Increased gas price for priority
    denom: 'uhuahua',
    granter: process.env.CHIHUAHUA_GRANTER_ADDRESS
  },
];
...
async function main() {
  ...
  if (mode === 'timed') {
    ...
    console.log('Usage:');
    console.log('  node chihuahua.js timed [minutes]              - Execute after specified minutes (default: 10)');
    console.log('  node chihuahua.js unbonding <delegator_addr>   - Monitor unbonding completion and execute');
    console.log('  node chihuahua.js continuous                   - Real-time block monitoring (same-block execution)');
    console.log('  node chihuahua.js continuous-legacy            - Standard 2-second polling');
    console.log('');
    console.log('Examples:');
    console.log('  node chihuahua.js unbonding chihuahua1abc123...');
    console.log('  node chihuahua.js timed 5');
    console.log('  node chihuahua.js continuous');
    console.log('');
